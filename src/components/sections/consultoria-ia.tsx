    ...
    <section id="consultoria-ia" className="bg-[#0a0a1a] py-20 sm:py-28">
      <div className="container mx-auto px-6">
        ...
        <div className="mx-auto mt-16 grid max-w-none grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4">
          ...
          <div className="flex flex-col items-center text-center">
            <LineChart className="h-10 w-10 text-blue-200 mb-2 drop-shadow-[0_0_16px_rgba(80,200,255,0.7)]" />
          ...
          <div className="flex flex-col items-center text-center">
            <Eye className="h-10 w-10 text-blue-200 mb-2 drop-shadow-[0_0_16px_rgba(80,200,255,0.7)]" />
