      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-20">
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg text-foreground/80">
              El auge de la inteligencia artificial no representa únicamente un avance tecnológico, sino un nuevo paradigma productivo y social. Desde Vantia articulamos proyectos y servicios que permiten a las instituciones y empresas responder con agilidad y aprovechar las oportunidades que genera este cambio histórico.
            </p>
            <p className="text-lg text-foreground/80">
              Vantia combina la palabra <span className="font-semibold text-primary">avant</span> (adelante, en valenciano) y <span className="font-semibold text-primary">IA</span> (inteligencia artificial), como un símbolo de innovación con raíces sólidas y visión de futuro.
            </p>
          </div>
        </div>
      </div>
