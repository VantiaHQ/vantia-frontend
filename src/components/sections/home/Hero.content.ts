export const mainTitlePart1 = 'Recupera tu tiempo';
export const mainTitlePart2 = 'con IA.';
...
export const heroImageSrc = '/images/star-3d.png';
export const heroImageAlt = 'Estrella tridimensional flotante';
export const heroImageHint = '3d star';
