...
export const selectDateFirst = 'Selecciona un día para ver horarios.';
export const calendarNotConfigured =
  'Las reservas no están activas todavía (falta configurar Google Calendar en el servidor).';

export const submitLabel = 'Confirmar reserva';
export const submittingLabel = 'Reservando...';
