...
const LEFT_NODES = [
  { icon: Phone,          label: 'Llamada',   color: '#22d3ee' }, // Tailind cyan-400
  { icon: MessageSquare,  label: 'WhatsApp',  color: '#8b5cf6' }, // Tailind violet-500
...
export default function BrunoHeroAnimation() {
  ...
  return (
    <div
      ref={containerRef}
      className="relative w-full overflow-hidden rounded-3xl border border-blue-400/20 bg-[#070916] py-16 px-6 md:px-12 shadow-[0_0_50px_-12px_rgba(34,211,238,0.2)]"
    >
      {/* Background patterns */}
      ...
      <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
        ...
        <div className="h-[200px] w-[200px] rounded-full bg-cyan-500/10 blur-[80px] -translate-x-32" />
          ...
          {rightLines.map((ln, i) => {
            ...
            return (
              <g key={i}>
                ...
                <path d={`M${ln.x1},${ln.y1 + 4} C${cx},${ln.y1 + 4} ${cx},${ln.y2 + 8} ${ln.x2},${ln.y2 + 8}`} fill="none" stroke="url(#lg-r)" strokeWidth="0.5" strokeLinecap="round" opacity="0.4" />
                {/* glow dot */}
                <circle cx={pt.x} cy={pt.y} r="4" fill="#22d3ee" opacity="0.5" filter="url(#glow)" />
        ...
        <div className="flex items-center justify-center">
          <div className="relative flex items-center justify-center">
            ...
            <div className="relative h-[300px] w-[300px] flex items-center justify-center">
              ...
              />
              <div
                className="absolute rounded-full border border-cyan-400/20 animate-[spin_15s_linear_infinite_reverse]"
