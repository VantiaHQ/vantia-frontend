...
export default function ConfigurarAgente() {
	...
	return (
		<div className="min-h-screen bg-gray-50 flex flex-col items-center py-12 px-4">
			<div className="max-w-4xl w-full bg-white rounded-xl shadow-lg p-8 flex flex-row gap-8">
				<div className="flex-1">
          ...
          <h1 className="text-3xl font-bold mb-4 text-gray-900">
            ...
            <p className="text-sm mb-6 text-gray-700">
              ...
              esenciales y no pueden desactivarse.
				...
				<div className="w-80 bg-gray-100 rounded-lg p-6 flex flex-col justify-between h-full text-gray-900 sticky top-8">
					<div>
