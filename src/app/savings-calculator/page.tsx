  ...
  const ResultsCardContent = () => (
    <>
      <div className="w-full">
        <p className="text-lg text-blue-100">Dinero ahorrado al mes</p>
        <p className="text-5xl md:text-6xl font-extrabold tracking-tight">
          {formatoMoneda.format(costeMensualActual)}
        </p>
      </div>
      <div className="w-full">
        <p className="text-lg text-blue-100">Horas ahorradas al mes</p>
        <p className="text-5xl md:text-6xl font-extrabold tracking-tight">
      ...
      <div className="w-full pt-6 border-t border-blue-500/50">
        ...
        <div className="space-y-2 text-base text-blue-200">
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="w-full max-w-6xl mx-auto p-4 sm:p-6 md:p-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 pb-28 lg:pb-0">
            ...
            <CardContent className="space-y-8 pt-4">
               <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <Label htmlFor="interacciones" className="text-base font-medium text-gray-700">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <Label htmlFor="precio" className="text-base font-medium text-gray-700">
                    Precio por hora
                  </Label>
                  <span className="text-lg font-bold text-blue-600">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <Label htmlFor="duracion" className="text-base font-medium text-gray-700">
          ...
          <Card className="bg-gradient-to-br from-blue-600 to-indigo-700 text-white shadow-xl border-none hidden lg:flex flex-col">
            <CardHeader>
      ...
      {/* Bottom Bar (Mobile) */}
      <div className="fixed bottom-0 left-0 right-0 z-30 bg-white border-t border-gray-200 px-4 py-3 flex lg:hidden items-center justify-between shadow-lg">
        <div className="flex flex-col">
          <span className="text-xs text-gray-600">Ahorro mensual</span>
          <span className="text-lg font-bold text-blue-600">{formatoMoneda.format(costeMensualActual)}</span>
        </div>
        <div className="flex flex-col">
          <span className="text-xs text-gray-600">Horas / mes</span>
          <span className="text-lg font-bold text-blue-700">{Math.round(horasInvertidasMes)}h</span>
        </div>
        <Button onClick={() => setShowResultsMobile(true)} className="rounded-full bg-blue-600 text-white hover:bg-blue-700">Mostrar desglose</Button>
      </div>
      ...
      {showResultsMobile && (
        <div className="fixed inset-0 z-40 flex items-end justify-center lg:hidden">
          ...
          <div className="w-full max-w-md bg-gradient-to-br from-blue-600 to-indigo-700 text-white rounded-t-2xl p-6 shadow-lg animate-fadeInUp relative z-50">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-lg font-semibold">Tu ahorro mensual estimado</h3>
